class Components {
    ...
    initAppSearch() {
        (this.searchOption = document.getElementById("search-options")),
            ...
            (this.searchClose = document.getElementById(
        ...
        this.searchOption &&
            ["focus", "keyup"].forEach(function (e) {
                t.searchOption.addEventListener(e, function (e) {
                    0 < t.searchOption.value.length
                        ? (t.searchDropdown.classList.add("show"),
                          t.searchClose.classList.remove("d-none"))
                        : (t.searchDropdown.classList.remove("show"),
                          t.searchClose.classList.add("d-none"));
                });
            }),
            t.searchClose &&
        ...
        document.querySelectorAll("[data-choices]").forEach(function (e) {
            ...
            a["data-choices-groups"] &&
                ...
                a["data-choices-text-unique-true"] &&
                    ((t.duplicateItemsAllowed = !1), (t.paste = !1)),
            ...
            .forEach(function (e) {
                ...
                if (t)
                    for (let e = 0; e < t.length; e++)
                        a.push(document.querySelectorAll("#" + t[e])[0]);
                else a = [e];
    ...
    initToastNotification() {
        document.querySelectorAll("[data-toast]").forEach(function (t) {
            t.addEventListener("click", function () {
                var e = {};
                t.attributes["data-toast-text"] &&
                    (e.text = t.attributes["data-toast-text"].value.toString()),
                    t.attributes["data-toast-gravity"] &&
                        (e.gravity =
                            t.attributes[
                                "data-toast-gravity"
                            ].value.toString()),
                    t.attributes["data-toast-position"] &&
                        (e.position =
                            t.attributes[
                                "data-toast-position"
                            ].value.toString()),
                    t.attributes["data-toast-className"] &&
                        (e.className =
                            t.attributes[
                                "data-toast-className"
                            ].value.toString()),
                    t.attributes["data-toast-duration"] &&
                        (e.duration =
                            t.attributes[
                                "data-toast-duration"
                            ].value.toString()),
                    t.attributes["data-toast-close"] &&
                        (e.close =
                            t.attributes["data-toast-close"].value.toString()),
                    t.attributes["data-toast-style"] &&
                        (e.style =
                            t.attributes["data-toast-style"].value.toString()),
                    t.attributes["data-toast-offset"] &&
                        (e.offset = t.attributes["data-toast-offset"]),
                    Toastify({
                        newWindow: !0,
                        text: e.text,
                        gravity: e.gravity,
...
class ThemeLayout {
    ...
    changeMenuSize(e, t = !0) {
        this.html.setAttribute("data-menu-size", e),
    ...
    initSwitchListener() {
        ...
        e &&
            e.addEventListener("click", function (e) {
                "light" === a.config.theme
                    ? a.changeThemeMode("dark")
                    : a.changeThemeMode("light");
            });
        ...
        e &&
            e.addEventListener("click", function () {
                ...
                "hidden" !== t
                    ? "condensed" === t
                        ? a.changeMenuSize("condensed" == e ? "default" : e, !1)
                        : a.changeMenuSize("condensed", !1)
                    : a.showBackdrop(),
            ...
            document.querySelectorAll(".button-sm-hover").forEach(function (e) {
                e.addEventListener("click", function () {
                    ...
                    "sm-hover-active" === e &&
                        ("sm-hover-active" === t
                            ? a.changeMenuSize("sm-hover", !0)
                            : a.changeMenuSize("sm-hover-active", !0)),
                        "sm-hover" === e &&
                            ("sm-hover" === t
                                ? a.changeMenuSize("sm-hover-active", !0)
                                : a.changeMenuSize("sm-hover", !0));
